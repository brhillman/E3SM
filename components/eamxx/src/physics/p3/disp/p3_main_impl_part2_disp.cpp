  ...
  const P3Runtime& runtime_options)
{
  ...
  Kokkos::parallel_for(
    ...
    p3_main_part2(
      ...
      ekat::subview(qv2qi_depos_tend, i), ekat::subview(qv2qi_nucleat_tend, i), ekat::subview(qv2qi_vapdep_tend, i), ekat::subview(qc2qi_berg_tend, i),
      ekat::subview(qc2qi_hetero_freeze_tend, i), ekat::subview(qc2qi_collect_tend, i), ekat::subview(qr2qi_collect_tend, i), ekat::subview(qr2qi_immers_freeze_tend, i),
      ekat::subview(precip_total_tend, i),
