...
struct UnitWrap::UnitTest<D>::TestP3Conservation : public UnitWrap::UnitTest<D>::Base
{
  ...
  void cloud_water_conservation_tests_device() {
    ...
    Kokkos::parallel_for(RangePolicy(0, 1), KOKKOS_LAMBDA(const Int& i) {
      ...
      Pack qc2qi_immers_freeze_tend(cwdc_device(0).qc2qi_immers_freeze_tend);
  ...
  void ice_water_conservation_tests_device() {
    ...
    Kokkos::parallel_for(RangePolicy(0, 1), KOKKOS_LAMBDA(const Int& i) {
      ...
      Pack qc2qi_immers_freeze_tend(iwdc_device(0).qc2qi_immers_freeze_tend);
  ...
  void cloud_water_conservation_unit_bfb_tests() {
    ...
    Kokkos::parallel_for(RangePolicy(0, num_test_itrs), KOKKOS_LAMBDA(const Int& i) {
      ...
      // Init pack inputs
      Pack qc, qc2qr_autoconv_tend, qc2qr_accret_tend, qc2qi_collect_tend, qc2qi_immers_freeze_tend, qc2qr_ice_shed_tend, qc2qi_berg_tend, qi2qv_sublim_tend, qv2qi_vapdep_tend, qcheti_cnt, qicnt;
      Mask context;
  ...
  void ice_water_conservation_unit_bfb_tests()
  {
    ...
    Kokkos::parallel_for(RangePolicy(0, num_test_itrs), KOKKOS_LAMBDA(const Int& i) {
      ...
      // Init pack inputs
      Pack qi,qv2qi_vapdep_tend,qv2qi_nucleat_tend,qc2qi_berg_tend,qr2qi_collect_tend,qc2qi_collect_tend,qr2qi_immers_freeze_tend,qc2qi_immers_freeze_tend,qi2qv_sublim_tend,qi2qr_melt_tend,qinuc_cnt,qcheti_cnt,qicnt;
      Mask context;
      for (Int s = 0, vs = offset; s < Pack::n; ++s, ++vs) {
...
struct UnitWrap::UnitTest<D>::TestP3UpdatePrognosticIce : public UnitWrap::UnitTest<D>::Base
{
  void update_prognostic_ice_unit_bfb_tests() {
    ...
    Kokkos::parallel_for(RangePolicy(0, num_test_itrs), KOKKOS_LAMBDA(const Int& i) {
      ...
      // Init pack inputs
      Pack qc2qi_immers_freeze_tend, qc2qi_collect_tend, qc2qr_ice_shed_tend, nc_collect_tend, nc2ni_immers_freeze_tend, ncshdc, qr2qi_collect_tend, nr_collect_tend,
